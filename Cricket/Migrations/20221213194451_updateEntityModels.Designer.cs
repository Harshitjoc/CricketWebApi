...
namespace Cricket.Migrations
{
    ...
    [Migration("20221213194451_updateEntityModels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlayerEntityTeamEntity", b =>
                {
                    b.Property<int>("PlayerEntitiesId")
                        .HasColumnType("int");

                    b.Property<int>("TeamEntitiesId")
                        .HasColumnType("int");

                    b.HasKey("PlayerEntitiesId", "TeamEntitiesId");

                    b.HasIndex("TeamEntitiesId");
            ...
            modelBuilder.Entity("Cricket.Data.Models.TeamPlayerMapEntity", b =>
                {
                    b.HasOne("Cricket.Data.Models.PlayerEntity", "playerEntity")
                        .WithMany()
                        .HasForeignKey("playerEntityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cricket.Data.Models.TeamEntity", "teamEntity")
                        .WithMany()
                        .HasForeignKey("teamEntityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PlayerEntityTeamEntity", b =>
                {
                    b.HasOne("Cricket.Data.Models.PlayerEntity", null)
                        .WithMany()
                        .HasForeignKey("PlayerEntitiesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cricket.Data.Models.TeamEntity", null)
                        .WithMany()
                        .HasForeignKey("TeamEntitiesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
